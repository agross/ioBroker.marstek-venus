...
class Adapter {
    async initStates() {
        ...
        await this.setObjectNotExistsAsync('info', {
            type: 'channel', common: {name: 'Device information'}, native: {}
        });
        await this.setObjectNotExistsAsync('battery', {
            type: 'channel', common: {name: 'Battery'}, native: {}
        });
        await this.setObjectNotExistsAsync('power', {
            type: 'channel', common: {name: 'Power measurements'}, native: {}
        });
        await this.setObjectNotExistsAsync('energy', {
            type: 'channel', common: {name: 'Energy statistics'}, native: {}
        });
        await this.setObjectNotExistsAsync('control', {
            type: 'channel', common: {name: 'Control settings'}, native: {}
        });
        ...
        await this.setObjectNotExistsAsync('info.firmware', {
            type: 'state',
            common: {name: 'Firmware version', type: 'string', role: 'value', read: true, write: false},
            native: {}
        });
        ...
        await this.setObjectNotExistsAsync('power.pvVoltage', {
            type: 'state', common: { name: 'PV voltage', type: 'number', unit: 'V', role: 'value', read: true, write: false }, native: {}
        });
        await this.setObjectNotExistsAsync('power.pvCurrent', {
            type: 'state', common: { name: 'PV current', type: 'number', unit: 'A', role: 'value', read: true, write: false }, native: {}
        });
        ...
        await this.setObjectNotExistsAsync('energy.pvTotal', {
            type: 'state', common: { name: 'Total PV energy', type: 'number', unit: 'Wh', role: 'value.energy', read: true, write: false }, native: {}
        });
        await this.setObjectNotExistsAsync('energy.gridImport', {
            type: 'state', common: { name: 'Total grid import', type: 'number', unit: 'Wh', role: 'value.energy', read: true, write: false }, native: {}
        });
        await this.setObjectNotExistsAsync('energy.gridExport', {
            type: 'state', common: { name: 'Total grid export', type: 'number', unit: 'Wh', role: 'value.energy', read: true, write: false }, native: {}
        });
        await this.setObjectNotExistsAsync('energy.loadTotal', {
            type: 'state', common: { name: 'Total load energy', type: 'number', unit: 'Wh', role: 'value.energy', read: true, write: false }, native: {}
        });
