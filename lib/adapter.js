...
class Adapter {
	...
	async initStates() {
		...
		await this.setObjectNotExistsAsync("power.pv1", {
			type: "state",
			common: { name: "PV1 power", type: "number", unit: "W", role: "value.power", read: true, write: false },
			native: {},
		});
		await this.setObjectNotExistsAsync("power.pv1Voltage", {
			type: "state",
			common: { name: "PV1 voltage", type: "number", unit: "V", role: "value.voltage", read: true, write: false },
			native: {},
		});
		await this.setObjectNotExistsAsync("power.pv1Current", {
			type: "state",
			common: { name: "PV1 current", type: "number", unit: "A", role: "value.current", read: true, write: false },
			native: {},
		});
		await this.setObjectNotExistsAsync("power.pv1State", {
			type: "state",
			common: { name: "PV1 state", type: "number", role: "indicator", read: true, write: false },
			native: {},
		});

		await this.setObjectNotExistsAsync("power.pv2", {
			type: "state",
			common: { name: "PV2 power", type: "number", unit: "W", role: "value.power", read: true, write: false },
			native: {},
		});
		await this.setObjectNotExistsAsync("power.pv2Voltage", {
			type: "state",
			common: { name: "PV2 voltage", type: "number", unit: "V", role: "value.voltage", read: true, write: false },
			native: {},
		});
		await this.setObjectNotExistsAsync("power.pv2Current", {
			type: "state",
			common: { name: "PV2 current", type: "number", unit: "A", role: "value.current", read: true, write: false },
			native: {},
		});
		await this.setObjectNotExistsAsync("power.pv2State", {
			type: "state",
			common: { name: "PV2 state", type: "number", role: "indicator", read: true, write: false },
			native: {},
		});

		await this.setObjectNotExistsAsync("power.pv3", {
			type: "state",
			common: { name: "PV3 power", type: "number", unit: "W", role: "value.power", read: true, write: false },
			native: {},
		});
		await this.setObjectNotExistsAsync("power.pv3Voltage", {
			type: "state",
			common: { name: "PV3 voltage", type: "number", unit: "V", role: "value.voltage", read: true, write: false },
			native: {},
		});
		await this.setObjectNotExistsAsync("power.pv3Current", {
			type: "state",
			common: { name: "PV3 current", type: "number", unit: "A", role: "value.current", read: true, write: false },
			native: {},
		});
		await this.setObjectNotExistsAsync("power.pv3State", {
			type: "state",
			common: { name: "PV3 state", type: "number", role: "indicator", read: true, write: false },
			native: {},
		});

		await this.setObjectNotExistsAsync("power.pv4", {
			type: "state",
			common: { name: "PV4 power", type: "number", unit: "W", role: "value.power", read: true, write: false },
			native: {},
		});
		await this.setObjectNotExistsAsync("power.pv4Voltage", {
			type: "state",
			common: { name: "PV4 voltage", type: "number", unit: "V", role: "value.voltage", read: true, write: false },
			native: {},
		});
		await this.setObjectNotExistsAsync("power.pv4Current", {
			type: "state",
			common: { name: "PV4 current", type: "number", unit: "A", role: "value.current", read: true, write: false },
			native: {},
		});
		await this.setObjectNotExistsAsync("power.pv4State", {
			type: "state",
			common: { name: "PV4 state", type: "number", role: "indicator", read: true, write: false },
			native: {},
		});
		...
		await this.setObjectNotExistsAsync("control.mode", {
			...
			common: {
				...
				read: true,
				write: true,
				states: { Auto: "Auto", AI: "AI", Manual: "Manual", Passive: "Passive", Ups: "Ups" },
			},
			native: {},
		});
		...
		await this.setObjectNotExistsAsync("control.dodValue", {
			type: "state",
			common: {
				name: "Depth of discharge value",
				type: "number",
				unit: "%",
				role: "level",
				min: 30,
		...
		await this.setObjectNotExistsAsync("control.bleBroadcastEnabled", {
			type: "state",
			common: {
				name: "BLE broadcast enabled",
				type: "boolean",
				role: "switch",
				read: true,
				write: true,
		...
		await this.setObjectNotExistsAsync("control.ledState", {
			type: "state",
			common: {
				name: "Panel LED state",
				type: "boolean",
				role: "switch.light",
				read: true,
				write: true,
